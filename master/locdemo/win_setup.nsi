...
!insertmacro InstallLib DLL $ALREADY_INSTALLED REBOOT_NOTPROTECTED "C:\wxWidgets-2.8.11\lib\vc_dll\wxbase28u_net_vc_custom.dll"     "$SYSDIR\wxbase28u_net_vc_custom.dll" "$SYSDIR"
!insertmacro InstallLib DLL $ALREADY_INSTALLED REBOOT_NOTPROTECTED "C:\wxWidgets-2.8.11\lib\vc_dll\wxbase28u_odbc_vc_custom.dll"    "$SYSDIR\wxbase28u_odbc_vc_custom.dll" "$SYSDIR"
!insertmacro InstallLib DLL $ALREADY_INSTALLED REBOOT_NOTPROTECTED "C:\wxWidgets-2.8.11\lib\vc_dll\wxbase28u_vc_custom.dll"         "$SYSDIR\wxbase28u_vc_custom.dll" "$SYSDIR"
!insertmacro InstallLib DLL $ALREADY_INSTALLED REBOOT_NOTPROTECTED "C:\wxWidgets-2.8.11\lib\vc_dll\wxbase28u_xml_vc_custom.dll"     "$SYSDIR\wxbase28u_xml_vc_custom.dll" "$SYSDIR"
!insertmacro InstallLib DLL $ALREADY_INSTALLED REBOOT_NOTPROTECTED "C:\wxWidgets-2.8.11\lib\vc_dll\wxmsw28u_adv_vc_custom.dll"      "$SYSDIR\wxmsw28u_adv_vc_custom.dll" "$SYSDIR"
!insertmacro InstallLib DLL $ALREADY_INSTALLED REBOOT_NOTPROTECTED "C:\wxWidgets-2.8.11\lib\vc_dll\wxmsw28u_aui_vc_custom.dll"      "$SYSDIR\wxmsw28u_aui_vc_custom.dll" "$SYSDIR"
!insertmacro InstallLib DLL $ALREADY_INSTALLED REBOOT_NOTPROTECTED "C:\wxWidgets-2.8.11\lib\vc_dll\wxmsw28u_core_vc_custom.dll"     "$SYSDIR\wxmsw28u_core_vc_custom.dll" "$SYSDIR"
!insertmacro InstallLib DLL $ALREADY_INSTALLED REBOOT_NOTPROTECTED "C:\wxWidgets-2.8.11\lib\vc_dll\wxmsw28u_gl_vc_custom.dll"       "$SYSDIR\wxmsw28u_gl_vc_custom.dll" "$SYSDIR"
!insertmacro InstallLib DLL $ALREADY_INSTALLED REBOOT_NOTPROTECTED "C:\wxWidgets-2.8.11\lib\vc_dll\wxmsw28u_html_vc_custom.dll"     "$SYSDIR\wxmsw28u_html_vc_custom.dll" "$SYSDIR"
!insertmacro InstallLib DLL $ALREADY_INSTALLED REBOOT_NOTPROTECTED "C:\wxWidgets-2.8.11\lib\vc_dll\wxmsw28u_media_vc_custom.dll"    "$SYSDIR\wxmsw28u_media_vc_custom.dll" "$SYSDIR"
!insertmacro InstallLib DLL $ALREADY_INSTALLED REBOOT_NOTPROTECTED "C:\wxWidgets-2.8.11\lib\vc_dll\wxmsw28u_richtext_vc_custom.dll" "$SYSDIR\wxmsw28u_richtext_vc_custom.dll" "$SYSDIR"
!insertmacro InstallLib DLL $ALREADY_INSTALLED REBOOT_NOTPROTECTED "C:\wxWidgets-2.8.11\lib\vc_dll\wxmsw28u_xrc_vc_custom.dll"      "$SYSDIR\wxmsw28u_xrc_vc_custom.dll" "$SYSDIR"
